...
197 ms: ***********************************************************************
197 ms: The number of maskable pairs: 130
292 ms: ***********************************************************************
292 ms: size: 8 -> SAT
292 ms: ***********************************************************************
292 ms: CDA is: 
292 ms: | 0 |: v1, v1, v1, false, true
292 ms: | 1 |: v1, v1, v2, true, true
292 ms: | 2 |: v1, v2, v1, false, false
292 ms: | 3 |: v1, v2, v2, true, false
292 ms: | 4 |: v2, v1, v1, false, false
292 ms: | 5 |: v2, v1, v2, false, false
292 ms: | 6 |: v2, v2, v1, false, false
292 ms: | 7 |: v2, v2, v2, false, false
292 ms: ***********************************************************************
292 ms: Initial size (CCA size): 7
403 ms: ***********************************************************************
403 ms: The number of maskable pairs: 130
632 ms: ***********************************************************************
633 ms: size: 7 -> UNSAT
633 ms: ***********************************************************************
634 ms: Execution details: 
634 ms: size: 8, SAT check time: 92(ms), expressions num: 1302
634 ms: =======================================================================
634 ms: < Minimum > size: 8, SAT check time: 92(ms), expressions num: 1302
634 ms: =======================================================================
634 ms: Final Results
634 ms: =======================================================================
634 ms: (Exists) => size: 8, SAT check time: 92(ms), expressions num: 1302
634 ms: (UNEXISTS) => size: 7, SAT check time: 228(ms), expressions num: 1285
634 ms: =======================================================================
634 ms: System Terminating
634 ms: =======================================================================
